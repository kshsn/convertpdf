...
export default function PDFToJPGPage() {
  ...
  async function handleConvert() {
    ...
    try {
      ...
      const res = await fetch("/api/process/pdf-to-jpg", {
        method: "POST",
        body: form,
      });
      ...
      <div className="max-w-2xl mx-auto">
        ...
        {status === "processing" && (
          <div className="text-center py-16">
            ...
            <p className="text-gray-600 font-medium">Converting to JPG...</p>
        ...
        <section className="mt-16 text-gray-600">
          ...
          <p>
            Upload your PDF and we convert each page to a high-resolution JPG
            image. All pages are bundled into a ZIP file for easy download.
          </p>
          <div className="mt-4 space-y-3">
            {[
              {
                q: "What resolution are the JPG images?",
                a: "Images are exported at 150 DPI by default — high enough for screen and standard printing.",
              },
              {
                q: "Can I convert just one page?",
                a: "Upload a single-page PDF or use our Split PDF tool first to extract the page you need.",
              },
              {
                q: "Is it free?",
                a: "Yes, completely free with no watermarks on the images.",
              },
            ].map(({ q, a }) => (
